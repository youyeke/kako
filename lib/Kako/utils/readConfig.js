...
function getItem(itemConfig, index, props) {
  ...
  var contentMap = (0, _objectSpread2.default)({
    'default': function _default() {
      return _react.default.createElement("div", null, "\u7EC4\u4EF6 ", component, " \u672A\u5B9A\u4E49");
    }
  }, extendsComponent);
  var Content = contentMap[component] || contentMap['default'];
  return _react.default.createElement(_Animation.BaseEnter, (0, _extends2.default)({}, restConfig, {
    key: index
  }), PREVENTRENDER ? null : _react.default.createElement(Content, props));
}
...
function setBaseComponentExtends(extendsObj) {
  extendsComponent = (0, _objectSpread2.default)({}, extendsComponent, extendsObj);
}
/**
 *
