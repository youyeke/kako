...
var baseType = {
  ...
  /*#__PURE__*/
  function (_Component) {
    _inherits(SelectWrapped, _Component);

    function SelectWrapped() {
      _classCallCheck(this, SelectWrapped);

      return _possibleConstructorReturn(this, _getPrototypeOf(SelectWrapped).apply(this, arguments));
    }

    _createClass(SelectWrapped, [{
      key: "render",
...
function getFormItemType(type, props) {
  ...
  var typeMap = _objectSpread({}, baseType);
