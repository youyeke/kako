...
/*#__PURE__*/
function (_Component) {
  _inherits(SearchDefault, _Component);

  function SearchDefault() {
    _classCallCheck(this, SearchDefault);

    return _possibleConstructorReturn(this, _getPrototypeOf(SearchDefault).apply(this, arguments));
  }

  _createClass(SearchDefault, [{
    key: "render",
