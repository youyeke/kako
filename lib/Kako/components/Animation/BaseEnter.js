...
/*#__PURE__*/
function (_Component) {
  _inherits(BaseEnter, _Component);

  function BaseEnter() {
    _classCallCheck(this, BaseEnter);

    return _possibleConstructorReturn(this, _getPrototypeOf(BaseEnter).apply(this, arguments));
  }

  _createClass(BaseEnter, [{
    key: "render",
