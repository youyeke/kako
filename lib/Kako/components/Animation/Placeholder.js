  ...
  _createClass(Placeholder, [{
    ...
    value: function render() {
      var _this$props = this.props,
          suppor = _this$props.suppor,
          mark = _this$props.mark,
          children = _this$props.children,
          restProps = _objectWithoutProperties(_this$props, ["suppor", "mark", "children"]);

      var ready = this.state.ready;
      return _react.default.createElement("div", null, _react.default.cloneElement(children, _objectSpread({
        key: 'content'
      }, restProps, {
