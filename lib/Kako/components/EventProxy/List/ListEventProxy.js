...
var _ListEventSet = require("./ListEventSet");
...
/*#__PURE__*/
function (_Component) {
  _inherits(ListEventProxy, _Component);

  function ListEventProxy(props) {
    var _this;

    _classCallCheck(this, ListEventProxy);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ListEventProxy).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDelete", function (record) {
  ...
  _createClass(ListEventProxy, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_ListEventSet.Provider, {
        value: EventSet
  ...
  return ListEventProxy;
}(_react.Component);

exports.default = ListEventProxy;