...
var _default = function _default(componentName) {
  ...
  function (_Component) {
    ...
    function DateWrapped(props) {
      ...
      (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "onChange", function (moment, dateString) {
    ...
    (0, _createClass2.default)(DateWrapped, [{
      ...
      value: function render() {
        ...
        var _options$format3 = options.format,
            format = _options$format3 === void 0 ? formatMap[componentName] : _options$format3;
      ...
      value: function getDerivedStateFromProps(nextProps, prevState) {
        if (prevState.originalValue !== nextProps.value) {
          ...
          var _options$nowTime2 = options.nowTime,
              ...
              _options$format4 = options.format,
              format = _options$format4 === void 0 ? formatMap[componentName] : _options$format4;
          return {
            originalValue: value,
            value: initTime({
              value: value,
...
function initTime(_ref) {
  ...
  if (Array.isArray(value)) {
    if (value[0] instanceof _moment.default) {
      ...
      return [(0, _moment.default)(value[0]).format(format), (0, _moment.default)(value[1]).format(format)];
    }
  }
  ...
  if (value) {
    ...
    return nowTime ? componentName === 'range' ? [(0, _moment.default)().format(format), (0, _moment.default)().format(format)] : (0, _moment.default)().format(format) : undefined;
  }
}